...
with col1:
    ...
    with sub_col2:
        st.markdown(f'''<p><a href={pathloss_url} class="btn btn-outline-primary btn-lg btn-block" type="button" aria-pressed="true">View File</a></p>''',
...
with col2:
    ...
    with sub_col2:
        st.markdown(f'''<p><a href={antennas_url} class="btn btn-outline-primary btn-lg btn-block" type="button" aria-pressed="true">View File</a></p>''',
                unsafe_allow_html=True)
